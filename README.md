...
- **Architecture:** Strong advocate for **MVVM/MVI**, **Clean Architecture**, and the **Repository pattern**.
- **Recent Achievement:** Participated in **HackYeah 2025**, Poland's largest hackathon, delivering a functional prototype under a 24-hour deadline.
...
- **[Messenger App](https://github.com/DerekBurned)** *(2025 – present)* — Real-time Android messaging app using **Firebase**, **Retrofit**, and REST protocols, with focus on UI responsiveness across network states.
...
- **AI Agent Development Workshop** *(November 2025)* — Hands-on LLM integration and agent orchestration training by **Bielik.AI & Google for Developers**
